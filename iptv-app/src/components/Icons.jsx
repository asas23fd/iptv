export const LogoIcon = ({ className = '' }) => (
  <svg className={className} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M18 14 L18 34 L36 24 Z" fill="white" opacity="0.95">
...
export const SeriesIcon = ({ className = '' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const VolumeIcon = ({ className = '', muted = false }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const FireIcon = ({ className = '' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M12 22c-4.97 0-9-2.69-9-6 0-4 5-11.5 9-14 4 2.5 9 10 9 14 0 3.31-4.03 6-9 6z" />
    <path d="M12 22c-1.66 0-3-1.34-3-3 0-2 3-6 3-6s3 4 3 6c0 1.66-1.34 3-3 3z" />
  </svg>
);
...
export const PrevIcon = ({ className = '' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M19 4L9 12l10 8V4zM6 4v16H4V4h2z" />
  </svg>
);
